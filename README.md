...
This is a programming language I made in C.  This is a progamming language inspired by HDL languages, made to be easy to use.  An example program is provided.  My C program compiles it and outputs its result.
